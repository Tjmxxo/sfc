...
<div class="page-container">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a
            ...
            class="r">共有数据：<strong>${hall.size()}</strong> 条</span></div>
    <div class="mt-20">
        ...
        <table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
            ...
            <c:forEach var="hall" items="${hall}">
                <form action="<%=basepath%>/urgency/hall">
                    <tr class="text-c" class="changes">
                        <td><input type="checkbox" value="1" name=""></td>
                        <input id="class1" name="hallId" type="hidden" value="${hall.hallId}">
                        <td>${hall.hallName}</td>
                        <td class="changessss"><a class="btn-link" class="input-text" href="<%=basepath %>/seatchangeurgency?hallId=${hall.hallId}">选择座位</a></td>
                        <td><input type="text" class="input-text" style="width: 50px;" name="time" value="0" placeholder="不填为永久"></td>
                        <td><input type="submit" class="btn btn-success radius" value="紧急停止"/></td>
